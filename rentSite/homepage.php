    ...
    <div class="container">
      <nav class="menu">
        ...
        <ul>
          ...
          <a href="index.php" class="login1">Login</a>
        </ul>
      ...
      <div class="homepage1">
        <ul class="boxkiri">
          <div class="text1"><h5>Bingung Mau Pinjam Gedung?</h5></div>
          <div class="text2">
      ...
      <div class="homepage2">
        ...
        <div class="box3">
          ...
          <div class="tigabulat2"><div class="tigabulat7"></div></div>
          <div class="kontenbox2 kontenbox">
            <p class="text">Bookoing Gedung</p>
            <button class="button">klik Disini</button>
          </div>
          <div class="tigabulat3"><div class="tigabulat7"></div></div>
          <div class="kontenbox3 kontenbox">
            <p class="text">Submit Berkas</p>
            <button class="button">klik Disini</button>
          </div>
          <div class="tigabulat4"><div class="tigabulat7"></div></div>
          <div class="kontenbox4 kontenbox">
            <p class="text">Verifikasi Berkas</p>
            <button class="button">klik Disini</button>
          </div>
          <div class="tigabulat5"><div class="tigabulat7"></div></div>
